...
export function NanniPage() {
  ...
  return (
    <div className={`flex flex-col mobile-full-screen overflow-hidden transition-all duration-500 ease-in-out bg-[#F0F0F0]`}>
      {/* Background Layer with Flex Positioning */}
      <div className="flex-1 flex flex-col relative">
        {/* Decorative Background Elements */}
        <BackgroundEffects isBlankBg={true} />
...
function ListeningView() {
  return (
    <div className="flex flex-col items-center justify-center space-y-6 max-w-sm mx-auto mt-[100px] px-4">
      {/* Listening Header */}
      
      {/* Character Illustration */}
      <div className="flex flex-col justify-center">
        <WinglooIllustration isListening={true} />
