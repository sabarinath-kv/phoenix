...
export const EndChat = () => {
  ...
  return (
    <div
      className={`flex flex-col mobile-full-screen overflow-hidden transition-all duration-500 ease-in-out`}
    >
          ...
          <div className="flex flex-col items-center justify-center pt-[120px] space-y-6 flex-shrink-0">
            <div className="relative w-full">
              <div className={`transition-all duration-300s`}>
                <MainContent
                  aiTranscript={`Based on what you told me, I've selected  the some games for ${
